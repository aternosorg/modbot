...
(async () => {
    ...
    await database.query("CREATE TABLE IF NOT EXISTS `responses` (`id` int PRIMARY KEY AUTO_INCREMENT, `guildid` VARCHAR(20) NOT NULL, `global` BOOLEAN NOT NULL, `channels` TEXT NULL DEFAULT NULL response` TEXT NOT NULL)");
