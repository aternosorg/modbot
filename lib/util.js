...
/**
 * how long configs are cached (ms)
 * @type {Number}
 */
...
/**
 * color.resolve - resolves an action to a color
...
/**
 * channelMentionToId - Converts a channel mention (<#channelId>) or channel id to a channel id
...
/**
 * roleMentionToId - Converts a role mention (<@&roleId>) or role id to a role id
...
/**
 * userMentionToId - Converts a user mention (<@!userId> or <@userId>) or user id to a user id
...
/**
 * isUserMention - is mention a valid user mention?
 * @async
 * @param {String|Discord.Snowflake} mention user mention (<@!userId> or <@userId>) or user id
 * @return {Boolean}
 */
...
/**
 * timeToSec - converts a time string ("1d 5h 2s") to seconds. Supported time values: s, m, h, d, w, M, y
...
/**
 * secToTime - converts seconds ("1d 5h 2s") to a time string. Supported time values: s, m, h, d, M, y
...
/**
 * isTime - is this a valid time word (1s)
...
/**
 * resolveGuild - resolves a guildInfo to a guild
 * @async
...
/**
 * logMessage - logs a message to the guilds log channel (if specified)
 * @async
...
/**
 * logMessageDeletion - logs the deletion of a message to the guilds log channel (if specified)
 * @async
...
/**
 * logMessageEmbed - logs a message and an embed to the guilds log channel (if specified)
 * @async
 * @param {GuildInfo}                   guildInfo guild
 * @param {String}                      message   message to log
...
/**
 * sendEmbed - sends an embed to the channel
 * @async
...
/**
 * logMessageModeration - log a moderation
 * @async
 * @param {GuildInfo}     guildInfo
...
/**
 * chatSuccess - responde with an embed
 * @async
...
/**
 * logMessageChecks - log automatic unbans etc.
 * @async
 * @param {GuildInfo}     guildInfo
 * @param {Discord.User}  user      user that was moderated
 * @param {String}        reason    reason for the moderation
...
/**
 * getGuildConfig - get a guilds config from cache or db
 * @async
 * @param {GuildInfo} guildInfo
 * @return {GuildConfig}
 */
...
/**
* getChannelConfig - get a channels config from cache or db
* @async
...
/**
 * saveGuildConfig - save a guilds config to db and refresh cache
 * @async
...
/**
 * saveChannelConfig - save a channels config to db and refresh cache
 * @async
...
/**
 * refreshGuildConfig - reload guild config cache for a guild
 * @async
 * @param {Discord.Snowflake} guildId the guild's id
 * @return {String|null} "Success!" or null if no config was found
 */
...
/**
 * refreshChannelConfig - reload channel config cache for a channel
 * @async
...
/**
 * moderationDBAdd - save a moderation to the database
 * @async
...
/**
 * split - splits a string at one or multiple strings
...
/**
 * usage - get an Embed showing the usage of a command
 * @param {String} command the name of the command
 * @return {Discord.MessageEmbed}
 */
util.usage = (command) => {
  return help.getUse(command);
};

/**
* getMessages - fetch messages (even more then 100) from channel
* @async
...
/**
 * messagesBefore - fetch messages before message
 * @async
 * @param  {Discord.TextChannel|Discord.DMChannel}  channel
...
/**
 * messagesBefore - fetch messages after message
 * @async
 * @param  {Discord.TextChannel|Discord.DMChannel}  channel
...
/**
 * ignoresAutomod - is this message ignored by automoderation
 * @async
...
/**
 * bulkDelete - delete messages (even more then 100)
 * @async
 * @param {Discord.TextBasedChannel}              channel
...
/**
 * startsWithMultiple - does the string start with any of the strings
